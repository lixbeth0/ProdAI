...
```ts
import { useListAllHabits, useCreateNewGoal, useGetMyGoals, useLogHabitEntry } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useListAllHabits();
...
const { data, isPending, isSuccess, isError, error } = useLogHabitEntry(logHabitEntryVars);
...
```js
import { listAllHabits, createNewGoal, getMyGoals, logHabitEntry } from '@dataconnect/generated';


// Operation ListAllHabits: 
...
// Operation LogHabitEntry:  For variables, look at type LogHabitEntryVars in ../index.d.ts
